...
/// <summary>
///  File : Tileset.cs
///  Purpose : The tileset class is used to draw all tilesets
///             loaded in and keeps track of each tile's properties
/// </summary>
using System;
...
//                 {
// 	                //top line
// 	                mD3d.DrawLine(left + nScrollOSx, top + nScrollOSy, width + nScrollOSx, top + nScrollOSy, 0, 0, 255);
// 	                //bottom line
// 	                mD3d.DrawLine(left + nScrollOSx, height + nScrollOSy, width + nScrollOSx, height + nScrollOSy, 0, 0, 255);
// 	                //left line
// 	                mD3d.DrawLine(left + nScrollOSx, top + nScrollOSy, left + nScrollOSx, height + nScrollOSy, 0, 0, 255);
// 	                //right line
// 	                mD3d.DrawLine(width + nScrollOSx, top + nScrollOSy, width + nScrollOSx, height + nScrollOSy, 0, 0, 255);
// 	
// 	                // draw crosshair for anchor point
// 	                // horizontal line
// 	                mD3d.DrawLine(left + xPOI - 6 + nScrollOSx, top + yPOI + nScrollOSy, left + xPOI + 6 + nScrollOSx, top + yPOI + nScrollOSy, 255, 0, 0);
// 	                // vertical line
// 	                mD3d.DrawLine(left + xPOI + nScrollOSx, top + yPOI - 6 + nScrollOSy, left + xPOI + nScrollOSx, top + yPOI + 6 + nScrollOSy, 255, 0, 0);
//                 } 
//                 else
//                 {
                    //top line
