...
void CCollectedAchievements::Render()
{
	...
	CBitmapFont::GetInstance()->DrawString("KILLED THE SHREDDER", 390, 10,0.05f, 0.6f,D3DCOLOR_ARGB(255,0,255,0));
	CBitmapFont::GetInstance()->DrawString("KILLED THE SHREDDER", 392, 12,0.051f, 0.6f,D3DCOLOR_ARGB(255,255,0,0));
	GetTM()->Draw(GetAssets()->aBreakGame, 10,70, 0.8f,0.8f, &m_rRect, 0.0f,0.0f,0.0f, D3DCOLOR_ARGB(m_nAlpha[3], 255,255,255));
	CBitmapFont::GetInstance()->DrawString("ALL ACHIEVEMENTS UNLOCKED", 390, 80, 0.05f, 0.6f,D3DCOLOR_ARGB(255,0,255,0));
	CBitmapFont::GetInstance()->DrawString("ALL ACHIEVEMENTS UNLOCKED", 392, 82, 0.051f, 0.6f,D3DCOLOR_ARGB(255,255,0,0));
	GetTM()->Draw(GetAssets()->aCowabunga, 10,150, 0.8f,0.8f, &m_rRect, 0.0f,0.0f,0.0f, D3DCOLOR_ARGB(m_nAlpha[1], 255,255,255));
	CBitmapFont::GetInstance()->DrawString("LEVEL UP", 390, 160,0.05f, 0.6f,D3DCOLOR_ARGB(255,0,255,0));
	CBitmapFont::GetInstance()->DrawString("LEVEL UP", 392, 162,0.051f, 0.6f,D3DCOLOR_ARGB(255,255,0,0));
	GetTM()->Draw(GetAssets()->aFlipNow, 10,230, 0.8f,0.8f, &m_rRect, 0.0f,0.0f,0.0f, D3DCOLOR_ARGB(m_nAlpha[2], 255,255,255));
	CBitmapFont::GetInstance()->DrawString("ALL TURTLES DEAD", 390, 240,0.05f, 0.6f,D3DCOLOR_ARGB(255,0,255,0));
	CBitmapFont::GetInstance()->DrawString("ALL TURTLES DEAD", 392, 242,0.051f, 0.6f,D3DCOLOR_ARGB(255,255,0,0));
	GetTM()->Draw(GetAssets()->aLessonInPain, 10,310, 0.8f,0.8f, &m_rRect, 0.0f,0.0f,0.0f, D3DCOLOR_ARGB(m_nAlpha[5], 255,255,255));
	CBitmapFont::GetInstance()->DrawString("KILL 30 ENEMIES", 390, 320,0.05f, 0.6f,D3DCOLOR_ARGB(255,0,255,0));
	CBitmapFont::GetInstance()->DrawString("KILL 30 ENEMIES", 392, 322,0.051f, 0.6f,D3DCOLOR_ARGB(255,255,0,0));
	GetTM()->Draw(GetAssets()->aMegaKill, 10,390, 0.8f,0.8f, &m_rRect, 0.0f,0.0f,0.0f, D3DCOLOR_ARGB(m_nAlpha[6], 255,255,255));
	CBitmapFont::GetInstance()->DrawString("1 TURTLE KILLS 3 NINJAS", 400, 390,0.05f, 0.6f,D3DCOLOR_ARGB(255,0,255,0));
	CBitmapFont::GetInstance()->DrawString("1 TURTLE KILLS 3 NINJAS", 402, 392,0.051f, 0.6f,D3DCOLOR_ARGB(255,255,0,0));
	GetTM()->Draw(GetAssets()->aPartyTime, 10,470, 0.8f,0.8f, &m_rRect, 0.0f,0.0f,0.0f, D3DCOLOR_ARGB(m_nAlpha[0], 255,255,255));
	CBitmapFont::GetInstance()->DrawString("START NEW GAME", 390, 480,0.05f, 0.6f,D3DCOLOR_ARGB(255,0,255,0));
	CBitmapFont::GetInstance()->DrawString("START NEW GAME", 392, 482,0.051f, 0.6f,D3DCOLOR_ARGB(255,255,0,0));
	GetTM()->Draw(GetAssets()->aQuickFingers, 10,550, 0.8f,0.8f, &m_rRect, 0.0f,0.0f,0.0f, D3DCOLOR_ARGB(m_nAlpha[9], 255,255,255));
	CBitmapFont::GetInstance()->DrawString("100 PERCENT ON QTE", 390, 560,0.05f, 0.6f,D3DCOLOR_ARGB(255,0,255,0));
	CBitmapFont::GetInstance()->DrawString("100 PERCENT ON QTE", 392, 562,0.051f, 0.6f,D3DCOLOR_ARGB(255,255,0,0));
	GetTM()->Draw(GetAssets()->aStrikeHard, 10,630, 0.8f,0.8f, &m_rRect, 0.0f,0.0f,0.0f, D3DCOLOR_ARGB(m_nAlpha[4], 255,255,255));
	CBitmapFont::GetInstance()->DrawString("FIRST MAP COMPLETE", 390, 640,0.05f, 0.6f,D3DCOLOR_ARGB(255,0,255,0));
	CBitmapFont::GetInstance()->DrawString("FIRST MAP COMPLETE", 392, 642,0.051f, 0.6f,D3DCOLOR_ARGB(255,255,0,0));
	GetTM()->Draw(GetAssets()->aTrueNinja, 10,710, 0.8f,0.8f, &m_rRect, 0.0f,0.0f,0.0f, D3DCOLOR_ARGB(m_nAlpha[8], 255,255,255));
	CBitmapFont::GetInstance()->DrawString("UNLOCK ALL SKILLS", 390, 720,0.05f, 0.6f,D3DCOLOR_ARGB(255,0,255,0));
	CBitmapFont::GetInstance()->DrawString("UNLOCK ALL SKILLS", 392, 722,0.051f, 0.6f,D3DCOLOR_ARGB(255,255,0,0));
