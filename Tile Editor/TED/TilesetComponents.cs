...
/// <summary>
///  File : TilesetComponents.cs
///  Purpose : This generates all components that are placed in
///             newly made tileset's info tab
/// </summary>
using System;
...
namespace test
{
    ...
    {
        ToolTip toolTip1;
        public int m_nScrollX = 0;
        public int m_nScrollY = 0;
...
//             ((System.ComponentModel.ISupportInitialize)(this.nudTilesetGridWidth)).BeginInit();
            ...
            this.toolTip1.SetToolTip(this.lblTileWidth, "Individual cell width of the tileset tiles.");
            // 
            // nudTilesetGridWidth
            // 
