...
void CCollectedAchievements::Enter()
{
	...
	//SetBGImageID(GetAssets()->
	//SetBGHeight(GetTM()->GetTextureHeight(GetAssets()->
	//SetBGWidth(GetTM()->GetTextureWidth(GetAssets()->
	//CenterBGImage();
	//GetFMOD()->PlaySound(GetAssets()->
	//GetFMOD()->SetVolume(GetAssets()->  , GetGame()->GetMusicVolume());
